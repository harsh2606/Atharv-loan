...
public class HomeActivity extends AppCompatActivity {
    ...
    String[] demo = {"HDFC", "ICICI", "Edelweiss", "Aditya Birla",
            "IDFC First Bank","Bank of Baroda","State Bank of India"};


    int[] image ={R.drawable.hdfc,R.drawable.icici,R.drawable.edelweiss,R.drawable.adityabirla,R.drawable.idfc,R.drawable.bob,R.drawable.sbi};
...
//        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        CustomGrid adapter = new CustomGrid(HomeActivity.this, demo, image);
...
//                Toast.makeText(BusinessBankActivity.this, "You Clicked at " +demo[+ position], Toast.LENGTH_SHORT).show();
    ...
    private void Document(){
        ...
        final Dialog alertDialog1 = new Dialog(HomeActivity.this, R.style.CustomDialog);
        ...
        text.loadDataWithBaseURL("",
                "<html>\n" +
                        ...
                        "<li>Rate of Interest Between 6.85% to 10%.</li>\n" +
                        "<li>Require Document:-\n" +
